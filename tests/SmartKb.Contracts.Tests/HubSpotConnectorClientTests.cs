...
public class HubSpotConnectorClientTests
{
    ...
    {
        var hash1 = HubSpotConnectorClient.ComputeHash("test input");
        var hash2 = HubSpotConnectorClient.ComputeHash("test input");
    ...
    {
        var hash1 = HubSpotConnectorClient.ComputeHash("input A");
        var hash2 = HubSpotConnectorClient.ComputeHash("input B");
    ...
    {
        var hash = HubSpotConnectorClient.ComputeHash("test");
