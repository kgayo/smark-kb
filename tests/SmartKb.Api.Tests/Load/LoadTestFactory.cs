...
internal sealed class LoadTestFactory : WebApplicationFactory<Program>, IAsyncLifetime
{
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        builder.ConfigureAppConfiguration((_, config) =>
        {
            config.AddInMemoryCollection(new Dictionary<string, string?>
            {
                ...
                ["Session:MaxActiveSessionsPerUser"] = "500",
            });
        });
    ...
    public async Task EnsureDatabaseAsync()
    {
        ...
        {
            db.Tenants.AddRange(
                new TenantEntity { TenantId = "tenant-1", DisplayName = "Load Test Tenant 1", CreatedAt = DateTimeOffset.UtcNow },
                new TenantEntity { TenantId = "tenant-2", DisplayName = "Load Test Tenant 2", CreatedAt = DateTimeOffset.UtcNow });
