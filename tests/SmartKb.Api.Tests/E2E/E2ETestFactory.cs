...
internal sealed class E2ETestFactory : WebApplicationFactory<Program>, IAsyncLifetime
{
    ...
    public async Task EnsureDatabaseAsync()
    {
        ...
        if (!await db.Tenants.AnyAsync(t => t.TenantId == "tenant-1"))
        {
            db.Tenants.AddRange(
                ...
                new TenantEntity { TenantId = "tenant-2", DisplayName = "Test Tenant 2", CreatedAt = DateTimeOffset.UtcNow });
