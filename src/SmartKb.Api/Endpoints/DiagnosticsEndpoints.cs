    ...
    public static WebApplication MapDiagnosticsEndpoints(this WebApplication app)
    {
            ...
            [FromServices] SloSettings sloSettingsInstance) =>
        {
            ...
            return Results.Ok(ApiResponse<object>.Success(new
            {
                ...
                metrics = new
                {
                    chatLatencyMetric = Diagnostics.MetricNames.ChatLatencyMs,
                    chatRequestsMetric = Diagnostics.MetricNames.ChatRequestsTotal,
                    chatNoEvidenceMetric = Diagnostics.MetricNames.ChatNoEvidenceTotal,
                    syncDurationMetric = Diagnostics.MetricNames.SyncDurationMs,
                    syncCompletedMetric = Diagnostics.MetricNames.SyncCompletedTotal,
                    syncFailedMetric = Diagnostics.MetricNames.SyncFailedTotal,
                    deadLetterMetric = Diagnostics.MetricNames.DeadLetterTotal,
                    recordsProcessedMetric = Diagnostics.MetricNames.RecordsProcessedTotal,
                    piiRedactionsMetric = Diagnostics.MetricNames.PiiRedactionsTotal,
                    confidenceMetric = Diagnostics.MetricNames.ChatConfidence,
                    sourceRateLimitMetric = Diagnostics.MetricNames.SourceRateLimitTotal,
                },
